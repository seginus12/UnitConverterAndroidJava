...
public class SpeedActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    final HashMap<Pair<String, String>, String> mults = new HashMap<Pair<String, String>, String>() {
        {
            put(new Pair<>("Kilometer per hour", "Kilometer per hour"), "1");
            put(new Pair<>("Kilometer per hour", "Node"), "0.539957");

            put(new Pair<>("Node", "Node"), "1");
            put(new Pair<>("Node", "Kilometer per hour"), "1.852");
        }
    };
