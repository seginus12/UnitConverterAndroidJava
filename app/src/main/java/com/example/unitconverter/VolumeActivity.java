...
public class VolumeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    final String[] energyUnits = new String[]{
            "Cubic meter",
            "Liter",
            "Gallon",
    };
    ...
    final HashMap<Pair<String, String>, String> mults = new HashMap<Pair<String, String>, String>() {
        {
            put(new Pair<>("Cubic meter", "Cubic meter"), "1");
            put(new Pair<>("Cubic meter", "Liter"), "1000");
            put(new Pair<>("Cubic meter", "Gallon"), "220");

            put(new Pair<>("Liter", "Cubic meter"), "0.001");
            put(new Pair<>("Liter", "Liter"), "1");
            put(new Pair<>("Liter", "Gallon"), "0.219969");
            
            put(new Pair<>("Gallon", "Cubic meter"), "0.00454609");
            put(new Pair<>("Gallon", "Liter"), "4.546");
            put(new Pair<>("Gallon", "Gallon"), "1");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fromTextView.setText(energyUnits[0]);
        toTextView = (TextView) findViewById(R.id.toText);
        toTextView.setText(energyUnits[0]);
        fromEdit = (EditText) findViewById(R.id.fromText);
        toEdit = (EditText) findViewById(R.id.toText);
    ...
    public Dialog onCreateDialog(Button button) {
        ...
        builder.setTitle("Choose unit")
                .setSingleChoiceItems(energyUnits, -1,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int item) {
                                selectedUnit = Arrays.asList(energyUnits).get(item);
                            }
                        })
