...
public class TempActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void getResult() {
        ...
        if (fromUnit.equals("Fahrenheit") && toUnit.equals("Fahrenheit"))
            result = fahrenheitToFahrenheit(value);
        ...
        if (fromUnit.equals("Kelvin") && toUnit.equals("Kelvin"))
            result = kelvinToKelvin(value);
        if (result % 1 == 0)
    ...
    double celsiusToCelsius(double value){
        return value;
    }
    ...
    double fahrenheitToCelsius(double value){
        return (value - 32) / 0.5555555555555556;
    }

    double fahrenheitToFahrenheit(double value){
        return value;
    }

    double fahrenheitToKelvin(double value){
        return (value - 32) / 0.5555555555555556 +  273.15;
    }

    double kelvinToKelvin(double value){
        return value;
    }
